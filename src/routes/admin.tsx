...
export const Route = createFileRoute("/admin")({
  head: () => ({
    meta: [
      { title: "Administração — Backoffice · CD Aurirrubro" },
      { name: "description", content: "Backoffice do CD Aurirrubro: gestão de notícias, futebol, modalidades, corporate, multimédia, sócios e contactos." },
      { name: "robots", content: "noindex" },
      { property: "og:title", content: "Administração · CD Aurirrubro" },
      ...
      <aside className="hidden w-64 shrink-0 border-r border-border bg-secondary/40 lg:block">
        <div className="sticky top-0 max-h-screen overflow-y-auto p-6">
          <Link to="/" className="flex items-center gap-3">
            <img src={logo} alt="Emblema do CD Aurirrubro" width={816} height={816} className="h-10 w-10 object-contain" />
